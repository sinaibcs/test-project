...
class BeneficiaryShiftingResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            "id" => $this->id,
            'from_main_program_name_en' => $this->from_main_program_name_en,
            'from_main_program_name_bn' => $this->from_main_program_name_bn,
            ...
            'to_main_program_name_en' => $this->to_main_program_name_en,
            'to_main_program_name_bn' => $this->to_main_program_name_bn,
