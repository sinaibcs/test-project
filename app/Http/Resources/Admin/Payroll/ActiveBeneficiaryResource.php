...
class ActiveBeneficiaryResource extends JsonResource
{
    ...
    {
        // $isDuplicateAcc = $this->isDuplicateAccount();
        return [
            "id" => $this->id,
            "verification_number" => $this->verification_number,
            "payroll_id" => $this->payroll_id,
            "payroll_details_id" => $this->payroll_details_id,
            ...
            "beneficiaryIdsWithDuplicateAccount" => $this->beneficiaryIdsWithDuplicateAccount($this->isDuplicateAccount),
            // "isDuplicateAccount" => true,
            // "beneficiaryIdsWithDuplicateAccount" => [123,456,234566,3245676],
        ];
    }

    private function beneficiaryIdsWithDuplicateAccount($isDuplicateAcc){
        if($isDuplicateAcc){
