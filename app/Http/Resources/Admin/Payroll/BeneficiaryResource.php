...
class BeneficiaryResource extends JsonResource
{
    ...
    {
        if ($this->permanentUnion)
            return LocationResource::make($this->whenLoaded('permanentUnion'));
        if ($this->permanentPourashava)
            return LocationResource::make($this->whenLoaded('permanentPourashava'));
        if ($this->permanentWard)
            return LocationResource::make($this->whenLoaded('permanentWard'));
        return null;
    }
