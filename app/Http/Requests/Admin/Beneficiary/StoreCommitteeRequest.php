...
class StoreCommitteeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'location_type_id' => 'sometimes|integer|exists:lookups,id',
            'city_corp_id' => 'sometimes|integer|exists:locations,id',
            'district_pourashava_id' => 'sometimes|integer|exists:locations,id',
            'upazila_id' => 'sometimes|integer|exists:locations,id',
            'sub_location_type_id' => 'sometimes|integer|exists:lookups,id',
            'pourashava_id' => 'sometimes|integer|exists:locations,id',
