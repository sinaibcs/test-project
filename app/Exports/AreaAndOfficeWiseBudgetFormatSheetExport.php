...
class AreaAndOfficeWiseBudgetFormatSheetExport implements FromCollection, WithHeadings, WithEvents, WithTitle
{
    protected $division;
    private $totalRows = 0;
    ...
    public function collection()
    {
        $locations = DB::select("
            SELECT
                ...
                combined_allotment_office_area_view.*
            FROM combined_allotment_office_area_view
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("H1:H$rowCount")->getProtection()->setLocked(Protection::PROTECTION_UNPROTECTED);
