...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::table('beneficiaries', function (Blueprint $table) {
            ...
            $table->renameColumn('temp_profession', 'profession');
        });
    }
    ...
    public function down()
    {
        Schema::table('beneficiaries', function (Blueprint $table) {
            ...
            $table->string('temp_profession')->nullable();
        });

        // Copy data back from the int column to the temporary varchar column
        DB::table('beneficiaries')->update([
            'temp_profession' => DB::raw('CAST(profession AS CHAR)')
        ]);
