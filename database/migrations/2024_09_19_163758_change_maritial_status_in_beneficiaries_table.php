...
return new class extends Migration
{
    public function up()
    {
        Schema::table('beneficiaries', function (Blueprint $table) {
            ...
            $table->integer('temp_marital_status')->nullable();
        });

        // Copy data from the varchar column to the temporary integer column
        DB::table('beneficiaries')->update([
            'temp_marital_status' => DB::raw('CAST(marital_status AS SIGNED)')
        ]);
        ...
        Schema::table('beneficiaries', function (Blueprint $table) {
            ...
            $table->renameColumn('temp_marital_status', 'marital_status');
        });
    }
    ...
    public function down()
    {
        Schema::table('beneficiaries', function (Blueprint $table) {
            ...
            $table->string('temp_marital_status')->nullable();
        });

        // Copy data back from the int column to the temporary varchar column
        DB::table('beneficiaries')->update([
            'temp_marital_status' => DB::raw('CAST(marital_status AS CHAR)')
        ]);
