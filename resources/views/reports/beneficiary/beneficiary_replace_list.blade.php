...
<table class="border-table">
    ...
    <tr>
        ...
        <th rowspan="2">{{__("beneficiary_replace.sub_program_name")}}</th>
        <th rowspan="2">{{__("beneficiary_replace.replace_cause")}}</th>
    ...
    @foreach($beneficiaries as $index => $beneficiary)
        <tr>
            ...
            <td>{{app()->isLocale('bn') ? $beneficiary?->replace_cause_bn : $beneficiary?->replace_cause_en}}</td>

            <td>{{app()->isLocale('bn') ? \App\Facades\BengaliUtil::bn_date($beneficiary?->beneficiary_id) : $beneficiary?->beneficiary_id }}</td>
            ...
            <td>{{app()->isLocale('bn') ? \App\Facades\BengaliUtil::bn_date($beneficiary?->replace_with_beneficiary_id) : $beneficiary?->replace_with_beneficiary_id }}</td>
