...
<table style="width: 100%; border-collapse: collapse;margin-left:40px;">
 ...
 <td class="left" style="width:60%;font-size: 15px;">
   {{ $apiDataReceive->organization_name}}
</td>
</tr>
     <tr>
    <td class="left" style="width:30% ;font-size: 15px;">
 ...
 <td class="left" style="width:60%;font-size: 15px;">
   {{ $apiDataReceive->organization_phone}}
</td>
</tr>
 ...
 <td class="left" style="width:60%;font-size: 15px;">
   {{ $apiDataReceive->responsible_person_nid}}
</td>
</tr>
 <tr>
    <td class="left" style="width:30% ;font-size: 15px;">
...
<div class="center" style="font-size: 15px; margin-bottom: 1; padding-bottom: 1;">
    ...
    <table class="table-with-border">
        ...
        <tbody>
            @foreach($apiDataReceive->apiList as $key=>$api)
            <tr>
                   <td class="center">{{ $key+1}}</td>
                <td  class="center">{{ $api->name }}</td>
                <td  class="center">
                    <ul>
                        @foreach((array)$api->selected_columns as $column)
                        <li>{{ $column }}</li>
                        @endforeach
                    </ul>
                </td>
